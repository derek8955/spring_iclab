...
foreach_in_collection x [get_cells AFIFO_ACCOUNT_sync_w2r_m0_rq1_wptr_reg*] {
...
foreach_in_collection x [get_cells AFIFO_INA_sync_w2r_m0_rq1_wptr_reg*] {
  set_annotated_check -0 -setup -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
  set_annotated_check -0 -hold  -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
}

foreach_in_collection x [get_cells AFIFO_INT_sync_w2r_m0_rq1_wptr_reg*] {
  set_annotated_check -0 -setup -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
  set_annotated_check -0 -hold  -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
}

foreach_in_collection x [get_cell AFIFO_ACCOUNT_sync_r2w_m0_wq1_rptr_reg*] {
  set_annotated_check -0 -setup -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
  set_annotated_check -0 -hold  -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
}

foreach_in_collection x [get_cell AFIFO_INA_sync_r2w_m0_wq1_rptr_reg*] {
  set_annotated_check -0 -setup -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
  set_annotated_check -0 -hold  -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
}

foreach_in_collection x [get_cell AFIFO_INT_sync_r2w_m0_wq1_rptr_reg*] {
  set_annotated_check -0 -setup -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
  set_annotated_check -0 -hold  -from [get_object_name $x]/CK -to [get_object_name $x]/D -clock rise
}
